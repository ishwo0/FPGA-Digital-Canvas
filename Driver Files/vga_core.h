...
public:
   ...
   /**
    * generate pixels for a rectangle with no fill color in frame buffer 
   ...
   /**
    * generate pixels for a filled rectangle in frame buffer 
    * @param    x    top left x coordinate
    * @param    y    top left y coordinate
    * @param    w    width of rectangle
    * @param    h    height of rectangle
   ...
   /**
    * generate pixels for a circle with no fill in frame buffer
   ...
   /**
    * generate pixels for a filled circle in frame buffer (plot a dot with specified size/radius)
    * @param    x0   Center-point x coordinate
    * @param    y0   Center-point y coordinate
    * @param    r   Radius of circle
    * @param    color 16-bit 5-6-5 Color to fill with
